...
while(1)
	...
	Tim_Count0_VidCompareReg(128);
	_delay_ms(600);
	Tim_Count0_VidCompareReg(160);
	_delay_ms(200);
	Tim_Count0_VidCompareReg(150);
	_delay_ms(700);
	Tim_Count0_VidCompareReg(120);
	_delay_ms(450);
	Tim_Count0_VidCompareReg(100);
		_delay_ms(650);
		Tim_Count0_VidCompareReg(90);
		_delay_ms(400);
		Tim_Count0_VidCompareReg(100);
		_delay_ms(300);
		Tim_Count0_VidCompareReg(120);
		_delay_ms(450);
		Tim_Count0_VidCompareReg(130);
			_delay_ms(500);
	}
}
